...
1. Dado el fichero de datos [`genetica`](https://raw.githubusercontent.com/asalber/manual-r/master/datos/genetica.csv), realizar la siguientes operaciones de preprocesado.
