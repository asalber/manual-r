...
- `scale_x_continuos(limits = rango, breaks = cortes, labels = etiquetas, trans = transformación)`: Igual que la función anterior pero para el eje y.
...
1. El fichero [neonatos]((https://raw.githubusercontent.com/asalber/manual-r/master/datos/neonatos.csv)) contiene información sobre los recién nacidos en un hospital durante un año.
...
h. Dibujar un diagrama de dispersión del peso de los recién nacidos de madres fumadoras durante el embarazo, frente al número de cigarros que fumaban las madres, separando por facetas según el sexo y la edad de la madre.
