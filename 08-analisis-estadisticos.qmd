...
1. El fichero [`genetica`](https://raw.githubusercontent.com/asalber/manual-r/master/datos/genetica.csv), contiene información de la análitica fisiológica, microbiológica y bioquímica, de una muestra de ratas tratadas con distintos tratamientos.
...
e. Comprobar la homocedasticiad de varianzas de la variable IHS en los tres grupos de tratamiento.
...
g. Realizar los contrastes de comparación de medias de la variable IHS por pares de trataimentos.
